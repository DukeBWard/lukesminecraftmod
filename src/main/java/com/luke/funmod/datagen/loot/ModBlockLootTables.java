...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    // Replaces the loot table json files
    @Override
    protected void generate() {
        ...
        this.add(ModBlocks.SAPPHIRE_ORE.get(),
                block -> createSapphireLikeOreDrops(ModBlocks.SAPPHIRE_ORE.get(), ModItems.RAW_SAPPHIRE.get()));
        this.add(ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get(),
                block -> createSapphireLikeOreDrops(ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get(), ModItems.RAW_SAPPHIRE.get()));
        this.add(ModBlocks.NETHER_SAPPHIRE_ORE.get(),
                block -> createSapphireLikeOreDrops(ModBlocks.NETHER_SAPPHIRE_ORE.get(), ModItems.RAW_SAPPHIRE.get()));
        this.add(ModBlocks.END_STONE_SAPPHIRE_ORE.get(),
                block -> createSapphireLikeOreDrops(ModBlocks.END_STONE_SAPPHIRE_ORE.get(), ModItems.RAW_SAPPHIRE.get()));
    ...
    protected LootTable.Builder createSapphireLikeOreDrops(Block pBlock, Item item) {
